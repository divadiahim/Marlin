...
/**
 *
  Protection parameters for the heated chamber.
 */
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_X { 70, 250 }
  #define Z_STEPPER_ALIGN_Y { 70, 250 }
...
//  #define POWER_LOSS_RECOVERY
  ...
  //  #define POWER_LOSS_PIN         P1_26 // Pin to detect power loss
...
//#define I2C_POSITION_ENCODERS
   ...
   * this setting determines the minimum update time between  . A value of 100 works well with
